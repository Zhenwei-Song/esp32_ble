...
double calculate_per(double SNR)
{
    ...
    //printf("calculate_per ber: %f\n", ber);
    double per = 1 - pow(((pow((1 - ber), 15)) + 15 * ber * pow((1 - ber), 14)), 2);
